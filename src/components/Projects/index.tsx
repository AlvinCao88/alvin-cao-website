...
export default function Projects() {
  const projectTabs: TabInfo[] = [
    ...
    },
    {
      ...
      description:
        "An AI tool that helps with mental help with different avatars.",
    },
    {
    ...
    },
    {
      ...
      description:
        "My old website, for future reference and to see improvements.",
    },
  ];

  return (
    <div id="Projects" className="flex flex-col items-center pt-20 pb-10">
      <p className="font-title text-3xl md:text-5xl mb-2">Projects</p>
      <div className="text-accent text-sm md:text-md mb-5">Lasted Updated: JAN 2025</div>
      ...
      <a
        href="/projects"
        className="relative group flex items-center justify-between px-6 py-3 rounded-full mt-6 border border-4 border-border bg-transparent font-medium overflow-hidden"
      >
